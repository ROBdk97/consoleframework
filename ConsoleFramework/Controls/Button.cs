...
public class Button : ButtonBase
{
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        {
            Size minButtonSize = new(caption.Length + 10, 2);
    ...
    public override void Render(RenderingBuffer buffer)
    {
        ...
        if (Disabled)
        {
            captionAttrs = ControlTheme.ButtonDisabled;
        }
        else
        {
            captionAttrs = HasFocus ? ControlTheme.ButtonFocused : ControlTheme.ButtonNormal;
        }
