...
/// <summary>
/// Wraps the specified control with a frame and title.
/// </summary>
public class GroupBox : Control
{
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        {
            // If the control with its content doesn't fit in availableSize,
            // we allocate the content less space than it wants,
            // and therefore must use a repeated Measure call to set its actual sizes,
            // which will be used during placement
    ...
    {
        Attr attr = ControlTheme.GroupBorder;

        // Transparent background for the frame
        buffer.SetOpacityRect(0, 0, ActualWidth, ActualHeight, 3);
        // Completely transparent inside
